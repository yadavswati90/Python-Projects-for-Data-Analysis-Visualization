...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(figure=px.bar(average_sales,x='Vehicle_Type', y='Automobile_Sales', title='Average number of vehicle sold by vehicle type'))
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart2 = dcc.Graph(figure=px.line(yearly_data,x='Month',y='Automobile_Sales', title='Monthly Automobile Sales in year {}'.format(input_year)))
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data, values='Advertising_Expenditure', names='Vehicle_Type', title='Monthly Advertasing Expenditure in year {}'.format(input_year)))
